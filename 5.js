// Implement Array.prototype.find Polyfill

// Description:
// Recreate the functionality of JavaScript’s built-in Array.prototype.find method without using the original find. Your implementation should be added to the Array prototype so that it can be called on any array instance just like the native find.
...
// 5. It must return the **first value** for which the callback returns a truthy value.
// 6. If no value satisfies the callback condition, the method should return **undefined**.
...
// Example Usage:
// const arr = [5, 8, 12, 20];
// const result = arr.findPolyfill(num => num > 10);
// console.log(result); // 12

function findPolyfill(callback, thisArg) {
...
Array.prototype.findPolyfill = findPolyfill;
